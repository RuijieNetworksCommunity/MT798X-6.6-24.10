...
define Device/ruijie_rg-be72-pro
  ...
  DEVICE_PACKAGES += mt798x-2p5g-phy-firmware-internal kmod-mt7992-23-firmware kmod-mt7992-firmware mt7988-wo-firmware kmod-usb3 automount swconfig kmod-rtl837x_gsw
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += ruijie_rg-be72-pro

define Device/ruijie_rg-be72-pro-mod
  DEVICE_VENDOR := Ruijie
  DEVICE_MODEL := RG-BE72 Pro
  DEVICE_VARIANT := (U-Boot mod)
  DEVICE_DTS_DIR := ../dts
  KERNEL_IN_UBI := 1
  DEVICE_DTS := mt7988d-ruijie-rg-be72-pro-mod
  DEVICE_PACKAGES += mt798x-2p5g-phy-firmware-internal kmod-mt7992-23-firmware kmod-mt7992-firmware mt7988-wo-firmware kmod-usb3 automount swconfig kmod-rtl837x_gsw
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/hiveton_h87pro
  DEVICE_VENDOR := Hiveton
  DEVICE_MODEL := h87pro
  DEVICE_DTS := mt7987a-hiveton-h87pro
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := mt798x-2p5g-phy-firmware-internal swconfig kmod-rtl837x_gsw kmod-sfp blkid
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
